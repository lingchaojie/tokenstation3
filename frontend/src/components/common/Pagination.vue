<template>
  <div
    class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 dark:border-linear-hairline dark:bg-linear-surface-1 sm:px-6"
  >
    <div class="flex flex-1 items-center justify-between sm:hidden">
      ...
      <button
        ...
        :disabled="page === 1"
        class="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-linear-hairline dark:bg-linear-surface-1 dark:text-linear-ink-muted dark:hover:bg-linear-surface-2"
      >
      ...
      >
        ...
        <button
          ...
          :class="[
            ...
            pageNum === page
              ? 'z-10 border-primary-500 bg-primary-50 text-primary-600 dark:border-linear-hairline dark:bg-linear-surface-2 dark:text-linear-ink'
              : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-linear-hairline dark:bg-linear-surface-1 dark:text-linear-ink-muted dark:hover:bg-linear-surface-2',
