<template>
  ...
  <!-- Cursor logo mark -->
  <svg v-else-if="platform === 'cursor'" data-testid="cursor-platform-icon" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 4h8.2a5.8 5.8 0 0 1 0 11.6H9.8a2.2 2.2 0 1 0 0 4.4H20v-3.2H9.8a1 1 0 0 1 0-2h2.4a9 9 0 0 0 0-18H4v3.2Zm0 4.4v3.2h8.2a1 1 0 1 0 0-2H4Z" />
  </svg>
