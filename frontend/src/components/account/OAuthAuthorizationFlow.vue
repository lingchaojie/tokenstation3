...
watch(authCodeInput, (newVal) => {
  if (props.platform !== 'openai' && props.platform !== 'gemini' && props.platform !== 'antigravity' && props.platform !== 'kiro' && props.platform !== 'grok' && props.platform !== 'cursor') return
  ...
  if (trimmed.includes('code=')) {
    try {
      ...
      if ((props.platform === 'openai' || props.platform === 'gemini' || props.platform === 'antigravity' || props.platform === 'kiro' || props.platform === 'grok' || props.platform === 'cursor') && stateParam) {
      ...
      if ((props.platform === 'openai' || props.platform === 'gemini' || props.platform === 'antigravity' || props.platform === 'kiro' || props.platform === 'grok' || props.platform === 'cursor') && stateMatch && stateMatch[1]) {
