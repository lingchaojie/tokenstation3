...
const showUsageWindows = computed(() => {
  ...
  // CN providers: API-key accounts expose either coding-plan quota or PAYG balance.
  // Eligible Ollama Cloud accounts are handled by the dedicated cell in the same branch.
  if (
...
const antigravityClaudeUsageFromAPI = computed(() =>
  getAntigravityUsageFromAPI([
    'claude-fable-5-1', 'claude-fable-5', 'claude-mythos-5',
