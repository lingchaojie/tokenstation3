<template>
  <header class="relative z-30 border-b border-gray-200 bg-white/90 backdrop-blur-xl dark:border-linear-hairline dark:bg-linear-canvas/90">
    <div class="flex h-14 items-center justify-between gap-2 px-4 md:px-5">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-lg border border-primary-500/20 bg-primary-500/10 px-3 py-1.5 sm:flex"
        >
          <svg
