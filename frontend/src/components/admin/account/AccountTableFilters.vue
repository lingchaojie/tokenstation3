...
import type { AccountPlatform, AdminGroup, SelectOption } from '@/types'
...
const accountPlatformOptions: readonly { value: AccountPlatform; label: string }[] = CONCRETE_PLATFORM_OPTIONS
const pOpts = computed<readonly SelectOption[]>(() => [
