    ...
    >
      <div class="space-y-4">
        ...
        <button
          ...
          class="flex w-full flex-col items-center gap-2 rounded-xl border-2 border-gray-200 p-4 transition-all hover:border-primary-500 hover:bg-primary-50 dark:border-dark-600 dark:hover:border-primary-500 dark:hover:bg-primary-900/20"
        >
...
import type { ApiKey, ApiKeyType, Group, GroupPlatform, PublicSettings, UpdateApiKeyRequest } from '@/types'
...
// Upstream fix: for quota-exhausted/expired keys, only submit a status change
// when the user is reactivating to "active"; otherwise leave status untouched so
// the edit does not clobber the exhausted/expired state.
