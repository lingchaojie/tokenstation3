    ...
    <div class="space-y-6">
      ...
      <div class="card">
        ...
        <div v-show="activeTab === 'errors'" class="overflow-hidden rounded-b-2xl">
          <div class="m-3 flex flex-wrap items-end gap-3 rounded-md border border-gray-200 bg-gray-50/60 p-3 dark:border-dark-700 dark:bg-dark-800/40">
...
const filters = ref<AdminUsageQueryParams>({ user_id: undefined, exclude_user_ids: undefined, model: undefined, group_id: undefined, request_type: undefined, native_compaction_v2: null, billing_type: null, start_date: startDate.value, end_date: endDate.value })
...
const resetFilters = () => {
  ...
  filters.value = { start_date: startDate.value, end_date: endDate.value, user_id: undefined, exclude_user_ids: undefined, request_type: undefined, native_compaction_v2: null, billing_type: null, billing_mode: undefined }
  granularity.value = getGranularityForRange(startDate.value, endDate.value)
