<template>
  <AppLayout>
	...
	<AccountActionMenu :show="menu.show" :account="menu.acc" :anchor-rect="menu.anchorRect" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @upstream-user-agents="handleViewUpstreamUserAgents" @schedule="handleSchedule" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" />
...
const handleViewUpstreamUserAgents = async (a: AccountListItem) => {
  const account = await loadAccountDetails(a)
  if (!account) return
  upstreamUserAgentsAcc.value = account
  showUpstreamUserAgents.value = true
}
