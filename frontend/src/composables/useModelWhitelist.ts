...
const anthropicPresetMappings = [
  ...
  { label: 'Mythos 5', from: 'claude-mythos-5', to: 'claude-mythos-5', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
...
const bedrockPresetMappings = [
  ...
  { label: 'Mythos 5', from: 'claude-mythos-5', to: 'anthropic.claude-mythos-5', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
