export default {
    accounts: {
      ...
      kiroMixedSchedulingTooltip: '启用后，该 Kiro 账号可参与 Anthropic 分组的 /v1/messages 混合调度，不会参与 Gemini 分组。建议配合分组和模型映射隔离 Kiro 与原生 Anthropic 账号，避免同一会话在不同上游之间切换。',
      ...
      oauth: {
        kiro: {
          ...
          externalIDPAuthUrlHint: '这是根据第一段 external_idp 回调生成的第二段链接。复制后在浏览器打开，完成 Microsoft 登录后再把返回的 /oauth/callback?code=... 地址粘贴到上方。',
          externalIDPAuthUrlCopy: '复制 M365 登录 URL',
          extIdpStagePortal: '阶段 1 · 企业租户识别',
          extIdpStageIdp: '阶段 2 · Microsoft 登录',
          extIdpStageHint: '门户回调已识别企业租户。请打开新的 Microsoft 地址，再粘贴 localhost:3128 回调链接。',
          ...
          deviceRegistrationHint: 'BuilderId 和 Enterprise 导入时必填。',
