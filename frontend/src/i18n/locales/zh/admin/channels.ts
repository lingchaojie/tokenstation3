export default {
    ...
    channels: {
      ...
      form: {
        ...
        reasoningEffortMultipliersHint: '按请求最终转发的思考等级，对整次请求的费用与额度消耗应用对应倍率。未配置时 Fable 5.1 的 max 按 3 倍计费，其他等级按 1 倍，可与其他计费倍率叠加。',
        reasoningEffortMultiplierLabel: '{effort} 思考等级倍率',
        reasoningEffortMultiplierDefault: '默认 {multiplier}',
    ...
    subscriptions: {
      batchAssign: {
        enable: '分配给多个用户',
        hint: '搜索并添加最多 100 个用户，为其分配相同分组和有效期。',
        selected: '已添加 {count} 个用户',
        removeUser: '移除 {email}',
        result: '分配完成：成功 {success} 个，失败 {failed} 个',
        retryHint: '成功用户已移除，请处理错误后再次提交剩余用户。'
      },
      bulk: {
        selected: '已选择 {count} 个订阅',
        selectSubscription: '选择订阅 #{id}',
        selectWindow: '选择配额窗口',
        selectionHint: '选择订阅后执行批量操作。',
        selectionLimit: '一次最多选择 {max} 个订阅。',
        selectionRequired: '请至少选择一个订阅。',
        clearSelection: '清除选择',
        confirm: '确认批量操作',
        confirmTargets: '确定对 {count} 个订阅执行此操作吗？',
        extendHint: '正数延长、负数缩短有效期。',
        resetHint: '请选择要重置的配额窗口。',
        resetWindows: '配额窗口',
        groupFallback: '使用各订阅分组默认值',
        invalidDays: '请输入非零整数天数。',
        result: '批量操作完成：成功 {success} 个，失败 {failed} 个',
        itemFailed: '订阅 #{id}：{error}',
        requestFailed: '批量操作请求失败',
        retry: '重试失败项',
        retryHint: '成功项已从选择中移除，请重试剩余失败项。'
      },
      sevenDay: '7 日额度',
      remaining: '剩余 {amount}',
      title: '订阅管理',
