export default {
  ...
  // Payment System
  payment: {
    noEnabledMethods: '暂无可用支付方式',
    noEnabledMethodsHint: '请在后台支付设置中启用支付宝或微信支付，并完成支付供应商配置后再重试。',
    paygRechargeReminderTitle: 'Pay-as-you-go 按量付费',
    paygRechargeReminderBody: '充值 1 人民币得 1 美金，余额按官方美元原价按量扣费，用多少扣多少。',
    subscriptionOverflowPaygHint: '订阅套餐额度用完，任务和 Coding 却停不下来？我们提供优惠的按量付费 Pay-as-you-go，用充值余额继续完成模型调用。',
    rechargeBalanceUsageOnlyHint: '充值余额仅可用于模型调用按量付费，无法用于购买订阅套餐。',
    ...
    admin: {
      ...
      virtualSeatStart: '虚拟起始量',
      virtualSeatTotal: '虚拟总量',
      virtualSeatRangeHint: '用户看到的限时名额区间；实际名额由虚拟总量减去虚拟起始量自动推导。',
      derivedSeatLimit: '实际名额',
      virtualSeatRangeRequired: '虚拟起始量和虚拟总量必须同时填写或同时留空',
      virtualSeatRangeInvalid: '虚拟总量必须大于或等于虚拟起始量，且都必须为非负整数',
      virtualSeatDisplay: '显示',
      seatUsage: '名额',
      seatUnlimited: '不限制',
      seatFull: '已满',
      seatOverLimit: '已超额',
