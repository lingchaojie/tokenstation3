export default {
    ...
    channels: {
      ...
      form: {
        ...
        reasoningEffortMultipliersHint: 'Apply the multiplier for the final forwarded reasoning effort to the entire request cost and quota usage. Unconfigured levels use 1×, except Fable 5.1 max uses 3×. These multiply with other billing multipliers.',
        reasoningEffortMultiplierLabel: '{effort} reasoning effort multiplier',
        reasoningEffortMultiplierDefault: 'Default: {multiplier}',
    ...
    subscriptions: {
      ...
      bulk: {
        ...
        selectWindow: 'Select a quota window',
        selectionHint: 'Select subscriptions to perform a bulk action.',
        ...
        confirmTargets: 'Apply this action to {count} subscriptions?',
        extendHint: 'Enter positive days to extend or negative days to shorten.',
        resetHint: 'Choose which quota window to reset.',
        resetWindows: 'Quota windows',
        groupFallback: 'Use each subscription group default',
        invalidDays: 'Enter a non-zero whole number of days.',
        result: 'Bulk action complete: {success} succeeded, {failed} failed',
        itemFailed: 'Subscription #{id}: {error}',
        requestFailed: 'Bulk action request failed',
        retry: 'Retry failed items',
        retryHint: 'Successful items are removed from the selection; retry the remaining failed items.'
      },
