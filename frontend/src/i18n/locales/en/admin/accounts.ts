export default {
    accounts: {
      ...
      kiroMixedSchedulingTooltip: 'When enabled, this Kiro account can participate in Anthropic group /v1/messages mixed scheduling. It does not participate in Gemini groups. Use groups and model mappings to isolate Kiro from native Anthropic accounts and avoid switching upstreams within one session.',
      ...
      grok: {
		...
		testMode: 'Test mode',
		testModeHint:
		  'Text / image / video use the selected model and its native generation endpoint.',
      ...
      oauth: {
        cursor: {
          ...
          refreshTokenDesc: 'Paste one Cursor refresh token per line. Each token creates an OAuth account.',
          refreshTokenPlaceholder: 'Paste Cursor refresh token(s), one per line',
          ssoCookieAuth: 'Session cookie or crsr_ API key',
          ssoCookieDesc: 'Paste Cursor session cookies or crsr_ API keys for one-time conversion.',
          ssoCookieLabel: 'One-time Cursor credentials',
          ssoCookiePlaceholder: 'Paste one session cookie or crsr_ API key per line',
          ssoCookieHint: 'Inputs are sent only to the conversion endpoint and are cleared after the response.',
        ...
        kiro: {
          ...
          externalIDPAuthUrlHint: 'This second URL is generated from the first external_idp callback. Copy and open it in your browser, then paste the returned /oauth/callback?code=... URL above after Microsoft sign-in.',
          ...
          extIdpStageHint: 'The portal callback identified your tenant. Open the new Microsoft URL, then paste the localhost:3128 callback.',
          ...
          deviceRegistrationHint: 'Required for BuilderId and Enterprise imports.',
