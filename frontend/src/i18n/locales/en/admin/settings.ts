    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          enabledHint: 'When off, the affiliate menu and signup code field are hidden, invite links return to regular signup, and no new rewards are granted. Existing credits keep their original expiry.',
