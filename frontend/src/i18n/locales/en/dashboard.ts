export default {
  ...
  usage: {
    ...
    errors: {
      ...
      requestErrorType: 'Request error type',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      reasoningMultiplierHint: 'When the forwarded reasoning effort is {effort}, billing and quota usage for the request are multiplied by {multiplier}. Unconfigured levels use 1×, except Fable 5.1 max uses 3×',
