export default {
  ...
  auth: {
    ...
    affiliateCodeLabel: 'Referral Code (Optional)',
    affiliateCodePlaceholder: 'Enter a referral code if you have one',
    affiliateCodeHint: "Enter a friend's referral code. Once your first recharge qualifies, both of you earn a reward.",
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      workBuddy: {
        description: 'Add the following config to the WorkBuddy custom model configuration file. The model id and name values use real model IDs supported by this gateway.',
  ...
  redeem: {
    ...
    subscriptionDurationUnknown: 'duration unknown',
    planActivated: 'Activated {planName}, valid for {duration}',
    planHistoryTitle: '{planName}',
  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        kiroOauth: 'Social OAuth / Organization Sign In / Import',
      ...
      oauth: {
        ...
        kiro: {
          ...
          idcTitle: 'Kiro Organization Sign In',
          importTitle: 'Import from Kiro IDE',
          socialSubtitle: 'Google / GitHub sign-in',
          idcSubtitle: 'Enterprise Identity Center / AWS Builder ID',
          googleOauth: 'Google OAuth',
          githubOauth: 'GitHub OAuth',
          idcLogin: 'Organization Sign In',
          importTokenFile: 'Import Token File',
          importSubtitle: 'Use this if you already signed in via Kiro IDE',
          startUrlLabel: 'Kiro Organization Start URL',
          idcStartUrlLabel: 'Kiro Organization Start URL',
          startUrlPlaceholder: 'https://d-xxxxxxxxxx.awsapps.com/start or https://view.awsapps.com/start',
          startUrlRequired: 'Please enter Kiro Organization Start URL',
          regionLabel: 'Region',
    ...
    redeem: {
      ...
      planActivationMode: 'Plan activation',
      legacyGroupMode: 'Legacy group mode',
      ...
      validityDaysOverride: 'Validity Days Override',
      planValidityDaysPlaceholder: 'Leave blank to use the plan default duration',
      planRequired: 'Please select a subscription plan',
      planValidityDaysInvalid: 'Validity days override must be a positive whole number',
      planForSale: 'For sale',
      planNotForSale: 'Not for sale',
      planFallback: 'Plan #{id}',
      planDefault: 'plan default',
      planDefaultDuration: 'plan default: {days} {unit}',
    ...
    usage: {
      ...
      allBillingModes: 'All Pricing Modes',
      ipAddress: 'IP',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; once the invitee’s first recharge qualifies, both parties earn a fixed reward. Disabled by default.',
          ...
          firstRechargeThreshold: 'First Recharge Threshold',
          firstRechargeThresholdHint: 'The reward is granted only after the invitee’s first recharge credits at least this amount (subscriptions always qualify). Only the first recharge counts.',
          inviterReward: 'Inviter Reward',
          inviterRewardHint: 'Fixed rebate quota the inviter earns once the invitee’s first recharge qualifies.',
          inviteeReward: 'Invitee Reward',
          inviteeRewardHint: 'Fixed account balance the invitee earns once their first recharge qualifies.',
          ...
          customUsers: {
            ...
            description: 'Set a custom invite code for specific users. Lists only users that have an override applied.',
          ...
          modal: {
            ...
            errorEmpty: 'Please enter a custom invite code',
          },
        },
      },
      ...
      payment: {
        ...
        field_ikunpayApiBaseHint: 'Default is https://ikunpay.com/. Change it only if your IkunPay account is assigned a different gateway endpoint.',
        field_merchantId: 'IkunPay Onboarded Merchant ID',
        field_channelIdAlipay: 'IkunPay Alipay Sub-channel ID',
        field_channelIdWxpay: 'IkunPay WeChat Pay Sub-channel ID',
        field_channelId: 'IkunPay Fallback Sub-channel ID',
        field_ikunpayMerchantIdHint: 'Optional. Usually leave this blank when using row IDs from IkunPay Payment Channels; fill it only if IkunPay explicitly requires merchant_id.',
        field_ikunpayChannelIdAlipayHint: 'Copy the Alipay row ID from IkunPay Payment Channels; it is sent as channel_id for Alipay orders.',
        field_ikunpayChannelIdWxpayHint: 'Copy the WeChat Pay row ID from IkunPay Payment Channels; it is sent as channel_id for WeChat Pay orders.',
        field_ikunpayChannelIdHint: 'Optional fallback. Fill only when Alipay and WeChat Pay share the same Payment Channels row ID; per-method channel IDs take priority.',
  ...
  payment: {
    ...
    noEnabledMethods: 'No payment method is enabled',
    noEnabledMethodsHint: 'Ask an administrator to enable Alipay or WeChat Pay and finish configuring the payment provider.',
    ...
    subscriptionOverflowPaygHint: 'Subscription quota used up but the task and coding session cannot stop? Pay-as-you-go keeps model calls running with discounted flexible billing.',
    rechargeBalanceUsageOnlyHint: 'Recharge balance can only be used for model-call pay-as-you-go billing. It cannot be used to buy subscription plans.',
    ...
    admin: {
      ...
      virtualSeatStart: 'Virtual display start',
      virtualSeatTotal: 'Virtual display total',
      virtualSeatRangeHint: 'Users see this limited-seat range; the real seat limit is derived from total minus start.',
      derivedSeatLimit: 'Real seats',
      virtualSeatRangeRequired: 'Virtual display start and total must be both filled or both empty',
      virtualSeatRangeInvalid: 'Virtual display total must be greater than or equal to start, and both values must be non-negative integers',
      virtualSeatDisplay: 'Display',
      seatUsage: 'Seats',
