export default {
  ...
  auth: {
    ...
    layout: {
      ...
      subtitleFallback: 'AI 网关平台 · 兼容 Anthropic / OpenAI 路由',
    },
    signIn: '登录',
    signingIn: '登录中...',
    createAccount: '创建账户',
  ...
  redeem: {
    ...
    subscriptionDurationUnknown: '有效期未知',
    planActivated: '已激活 {planName}，有效期 {duration}',
  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        kiroOauth: '社交 OAuth / Organization 登录 / 导入',
      ...
      kiroMixedScheduling: '加入 Anthropic /v1/messages 调度',
      kiroMixedSchedulingTooltip:
        '启用后，该 Kiro 账号可参与 Anthropic 分组的 /v1/messages 混合调度，不会参与 Gemini 分组。建议配合分组和模型映射隔离 Kiro 与原生 Anthropic 账号，避免同一会话在不同上游之间切换。',
      ...
      oauth: {
        ...
        kiro: {
          ...
          idcTitle: 'Kiro Organization 登录',
          importTitle: '从 Kiro IDE 导入',
          socialSubtitle: 'Google / GitHub 登录',
          idcSubtitle: '企业 Identity Center / AWS Builder ID',
          googleOauth: 'Google OAuth',
          githubOauth: 'GitHub OAuth',
          idcLogin: 'Organization 登录',
          ...
          startUrlPlaceholder: 'https://d-xxxxxxxxxx.awsapps.com/start 或 https://view.awsapps.com/start',
          startUrlRequired: '请输入 Kiro Organization Start URL',
          regionLabel: 'Region',
    ...
    redeem: {
      ...
      planActivationMode: '套餐激活',
      legacyGroupMode: '旧分组模式',
      selectPlan: '选择订阅套餐',
      selectPlanPlaceholder: '选择订阅套餐',
      noPlansAvailable: '暂无可用订阅套餐',
      validityDaysOverride: '有效天数覆盖',
      planValidityDaysPlaceholder: '留空则使用套餐默认时长',
      planRequired: '请选择订阅套餐',
      planValidityDaysInvalid: '有效天数覆盖必须为正整数',
      planForSale: '在售',
      planNotForSale: '未在售',
      planFallback: '套餐 #{id}',
      planDefault: '套餐默认',
      planDefaultDuration: '套餐默认：{days} {unit}',
      selectGroup: '选择分组',
    ...
    usage: {
      ...
      billingMode: '定价方式',
      billingModeToken: '按Token',
      billingModePerRequest: '按次',
      billingModeImage: '按次(图片)',
      allBillingModes: '全部定价方式',
      ipAddress: 'IP',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '邀请返利',
          description: '老用户邀请新用户注册，新用户首充达标后邀请双方各得固定奖励。默认关闭。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后用户菜单中的邀请页面入口隐藏、注册时忽略邀请码、新充值不再产生返利。已有返利额度仍可转入余额。',
          firstRechargeThreshold: '首充达标金额',
          firstRechargeThresholdHint: '被邀请用户首次充值到账额达到该金额后才发放奖励（订阅无条件达标）。仅统计首笔充值。',
          inviterReward: '邀请方奖励',
          inviterRewardHint: '被邀请用户首充达标后，邀请方获得的固定返利额度。',
          inviteeReward: '被邀请方奖励',
          inviteeRewardHint: '被邀请用户首充达标后，被邀请方获得的固定账户余额。',
          freezeHours: '返利冻结期（小时）',
          freezeHoursDesc: '新产生的返利将在冻结期内无法提现。0 = 不冻结。',
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置专属邀请码。仅展示已设置过专属配置的用户。',
            addButton: '添加专属用户',
      ...
      payment: {
        ...
        field_ikunpayApiBaseHint: '默认 https://ikunpay.com/。仅当 IkunPay 分配了其他网关地址时修改。',
        field_merchantId: 'IkunPay 进件商户 ID',
        field_channelIdAlipay: 'IkunPay 支付宝子通道 ID',
        field_channelIdWxpay: 'IkunPay 微信子通道 ID',
        field_channelId: 'IkunPay 通用子通道 ID',
        field_ikunpayMerchantIdHint: '可选。使用 IkunPay 后台“支付通道”行 ID 时通常留空；仅当 IkunPay 明确要求 merchant_id 时填写。',
        field_ikunpayChannelIdAlipayHint: '填写 IkunPay 后台“支付通道”中支付宝通道所在行的 ID；发起支付宝支付时作为 channel_id 传递。',
        field_ikunpayChannelIdWxpayHint: '填写 IkunPay 后台“支付通道”中微信支付通道所在行的 ID；发起微信支付时作为 channel_id 传递。',
        field_ikunpayChannelIdHint: '可选兜底。仅当支付宝和微信共用同一个支付通道行 ID 时填写；按支付方式配置的通道 ID 优先。',
