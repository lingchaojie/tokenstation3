...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gatewayService.SetCapturePool(conversationCapturePool)
	openAIGatewayService.SetCapturePool(conversationCapturePool)
