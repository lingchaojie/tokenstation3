...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	captureAdminService := service.NewCaptureAdminService(configConfig, settingService, conversationCapturePool, captureHealthRepository)
	...
	opsAlertEvaluatorService := service.ProvideOpsAlertEvaluatorService(opsService, opsRepository, emailService, redisClient, configConfig, proxyRepository, conversationCapturePool, captureHealthRepository)
