...
// Default OAuth text traffic uses the CLI gateway, but media APIs remain on
// api.x.ai. An explicitly configured custom forwarding base URL overrides
// both paths; stored official API/CLI variants retain the default split.
