...
func TestCountTokensKiroDirectUsesLocalEstimate(t *testing.T) {
	...
	accounts := []*Account{
		{ID: 101, Platform: PlatformKiro, Type: AccountTypeOAuth},
		{ID: 102, Platform: PlatformKiro, Type: AccountTypeAPIKey},
	}
...
func TestCountTokensKiroDirectClampsEstimateToOne(t *testing.T) {
	...
	err = (&GatewayService{}).ForwardCountTokens(context.Background(), c, &Account{
		ID: 103, Platform: PlatformKiro, Type: AccountTypeOAuth,
	}, parsed)
...
func TestCountTokensKiroImageUsesVisualEstimate(t *testing.T) {
	...
	require.NoError(t, err)
	err = (&GatewayService{}).ForwardCountTokens(context.Background(), c, &Account{
		ID: 105, Platform: PlatformKiro, Type: AccountTypeOAuth,
	}, parsed)
...
func TestCountTokensKiroAPIKeyBaseURLUsesUpstream(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	account := &Account{
		ID: 104, Platform: PlatformKiro, Type: AccountTypeAPIKey, Concurrency: 1,
