...
func (s *RedeemService) Redeem(ctx context.Context, userID int64, code string) (*RedeemCode, error) {
	...
	case RedeemTypeSubscription:
		if redeemCode.GroupID == nil && redeemCode.PlanID == nil {
			return nil, infraerrors.BadRequest("REDEEM_CODE_INVALID", "invalid subscription redeem code: missing group_id or plan_id")
		}
		if redeemCode.GroupID != nil && redeemCode.PlanID != nil {
			return nil, infraerrors.BadRequest("REDEEM_CODE_TARGET_CONFLICT", "plan_id and group_id cannot both be set for subscription type")
		}
	default:
