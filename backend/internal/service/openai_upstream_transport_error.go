...
// doOpenAIUpstream is the provider-neutral OpenAI HTTP transport boundary.
// Upstream briefly defined this helper in the optional plugin transport file;
// keeping the ordinary HTTP path here prevents core forwarding from depending
// on plugin runtime, routes, or configuration.
