...
func TestPaymentFulfillmentRestartsExpiredPlanSnapshotFromPurchaseCompletion(t *testing.T) {
	...
	require.WithinDuration(t, timezone.StartOfDay(after.StartsAt), *after.DailyWindowStart, time.Second)
...
func (r *paymentFulfillmentAffiliateRepoStub) AccrueQuota(context.Context, int64, int64, float64, int, *int64) (bool, error) {
