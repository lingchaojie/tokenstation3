...
var (
	...
	ErrWebChatMessageNotCancelable      = infraerrors.BadRequest("WEB_CHAT_MESSAGE_NOT_CANCELABLE", "message cannot be canceled")
	ErrWebChatInvalidConversationStatus = infraerrors.BadRequest("WEB_CHAT_INVALID_CONVERSATION_STATUS", "invalid conversation status")
)
