...
func (r *usageBatchLogRepoStub) GetByRequestIDAndAPIKeyID(context.Context, string, int64) (*UsageLog, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetUsageTrendWithUsageFilters(context.Context, time.Time, time.Time, string, usagestats.UsageLogFilters) ([]usagestats.TrendDataPoint, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetModelStatsWithUsageFiltersBySource(context.Context, time.Time, time.Time, usagestats.UsageLogFilters, string) ([]usagestats.ModelStat, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetGroupStatsWithUsageFilters(context.Context, time.Time, time.Time, usagestats.UsageLogFilters) ([]usagestats.GroupStat, error) {
	return nil, nil
}
