...
func (s *BillingService) initFallbackPricing() {
	...
	// Claude Fable 5 / 5.1 share standard input, output, and cache-write rates.
	// Fable 5.1 reduced cache reads from $1 to $0.25 per MTok, so the two
	// versions must remain separate and 5.1 must be matched first below.
