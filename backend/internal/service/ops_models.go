...
type OpsErrorLogFilter struct {
	...
	// With IncludeRecoveredUpstream, an ANY list made exclusively of provider
	// phases bypasses status>=400; mixed lists retain the guard. Used to map
	// user-facing coarse categories to backend conditions.
