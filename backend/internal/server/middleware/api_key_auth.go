...
func apiKeyAuthWithSubscription(apiKeyService *service.APIKeyService, subscriptionService *service.SubscriptionService, cfg *config.Config) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Billing introspection does not need subscription data. Usage keeps the
		// existing read behavior while all routed groups retain universal-plan lookup.
		if subscriptionService != nil && apiKey.Group != nil && !billingInfoRequest {
