...
var publicModelReleaseInfoByModel = map[string]modelReleaseInfo{
	...
	"claude-sonnet-4-5-20250929":      {ReleasedAt: "2025-09-29", ReleaseStatus: "confirmed"},
	...
	"gpt-image-2-count":               {ReleasedAt: "2026-06-15", ReleaseStatus: "unverified"},
	"gpt-image-2-hd-count":            {ReleasedAt: "2026-06-15", ReleaseStatus: "unverified"},
	"gpt-image-2-4k-count":            {ReleasedAt: "2026-06-15", ReleaseStatus: "unverified"},
	...
	"gemini-3.1-flash-image-count":    {ReleasedAt: "2026-03-01", ReleaseStatus: "unverified"},
	"gemini-3.1-flash-image-hd-count": {ReleasedAt: "2026-03-01", ReleaseStatus: "unverified"},
	"gemini-3.1-flash-image-4k-count": {ReleasedAt: "2026-03-01", ReleaseStatus: "unverified"},
	"gemini-3-pro-image-count":        {ReleasedAt: "2025-12-01", ReleaseStatus: "unverified"},
	"gemini-3-pro-image-hd-count":     {ReleasedAt: "2025-12-01", ReleaseStatus: "unverified"},
	"gemini-3-pro-image-4k-count":     {ReleasedAt: "2025-12-01", ReleaseStatus: "unverified"},
	"gemini-2.5-flash-image":          {ReleasedAt: "2025-06-01", ReleaseStatus: "unverified"},
	"gemini-2.5-flash-image-count":    {ReleasedAt: "2025-06-01", ReleaseStatus: "unverified"},
...
var publicModelCatalogModels = []dto.PublicModelCatalogModel{
	...
	catalogModel("anthropic", "Anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet 4.5 20250929", textModalities(), "Versioned Claude Sonnet 4.5 model for stable production routing.", 200000, contextSourceAnthropic, textFeatures("tool use", "prompt caching"), usdWithCache(3, 15, 0.3), "confirmed", sourceAnthropic),
	...
	catalogModel("gemini", "Gemini", "gemini-2.5-flash-image-count", "Gemini 2.5 Flash Image Count", imageModalities(), "Gemini image count route for fixed-price image generation.", 65536, contextSourceGemini, imageFeatures("image count"), withPriceLines(usd(0.5, 1.5), priceLine("1K image", 0.1, "image"), priceLine("2K image", 0.1, "image"), priceLine("4K image", 0.1, "image")), "confirmed", sourceGemini),
	...
	catalogModel("gemini", "Gemini", "gemini-3.1-flash-image-count", "Gemini 3.1 Flash Image Count", imageModalities(), "Gemini Flash image count route for standard output.", 131072, contextSourceGemini, imageFeatures("standard image"), withPriceLines(usd(0.5, 1.5), priceLine("Standard image", 0.3, "image")), "confirmed", sourceGemini),
	catalogModel("gemini", "Gemini", "gemini-3.1-flash-image-hd-count", "Gemini 3.1 Flash Image HD Count", imageModalities(), "Gemini Flash image count route for HD output.", 131072, contextSourceGemini, imageFeatures("HD image"), withPriceLines(usd(0.5, 1.5), priceLine("HD image", 0.4, "image")), "confirmed", sourceGemini),
	catalogModel("gemini", "Gemini", "gemini-3.1-flash-image-4k-count", "Gemini 3.1 Flash Image 4K Count", imageModalities(), "Gemini Flash image count route for 4K output.", 131072, contextSourceGemini, imageFeatures("4K image"), withPriceLines(usd(0.5, 1.5), priceLine("4K image", 0.55, "image")), "confirmed", sourceGemini),
	catalogModel("gemini", "Gemini", "gemini-3-pro-image-count", "Gemini 3 Pro Image Count", imageModalities(), "Gemini Pro image count route for standard output.", 65536, contextSourceGemini, imageFeatures("standard image"), withPriceLines(usd(0.5, 1.5), priceLine("Standard image", 0.4, "image")), "confirmed", sourceGemini),
	catalogModel("gemini", "Gemini", "gemini-3-pro-image-hd-count", "Gemini 3 Pro Image HD Count", imageModalities(), "Gemini Pro image count route for HD output.", 65536, contextSourceGemini, imageFeatures("HD image"), withPriceLines(usd(0.5, 1.5), priceLine("HD image", 0.4, "image")), "confirmed", sourceGemini),
	catalogModel("gemini", "Gemini", "gemini-3-pro-image-4k-count", "Gemini 3 Pro Image 4K Count", imageModalities(), "Gemini Pro image count route for 4K output.", 65536, contextSourceGemini, imageFeatures("4K image"), withPriceLines(usd(0.5, 1.5), priceLine("4K image", 0.5, "image")), "confirmed", sourceGemini),
