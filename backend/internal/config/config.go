...
//     Default false keeps the policy dormant until an operator explicitly opts in.
...
func setDefaults() {
	...
	viper.SetDefault("gateway.openai_compact_nonstream_keepalive_interval", 60)
	...
	// Dormant by default; operators can explicitly opt in after validating local usage data.
