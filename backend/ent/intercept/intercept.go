...
// The DailyCheckInClaimFunc type is an adapter to allow the use of ordinary function as a Querier.
type DailyCheckInClaimFunc func(context.Context, *ent.DailyCheckInClaimQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f DailyCheckInClaimFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.DailyCheckInClaimQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.DailyCheckInClaimQuery", q)
}

// The TraverseDailyCheckInClaim type is an adapter to allow the use of ordinary function as Traverser.
type TraverseDailyCheckInClaim func(context.Context, *ent.DailyCheckInClaimQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseDailyCheckInClaim) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseDailyCheckInClaim) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.DailyCheckInClaimQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.DailyCheckInClaimQuery", q)
}
...
// The UserAPIKeyRouteFunc type is an adapter to allow the use of ordinary function as a Querier.
type UserAPIKeyRouteFunc func(context.Context, *ent.UserAPIKeyRouteQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UserAPIKeyRouteFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserAPIKeyRouteQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserAPIKeyRouteQuery", q)
}

// The TraverseUserAPIKeyRoute type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserAPIKeyRoute func(context.Context, *ent.UserAPIKeyRouteQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserAPIKeyRoute) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserAPIKeyRoute) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserAPIKeyRouteQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UserAPIKeyRouteQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.DailyCheckInClaimQuery:
		return &query[*ent.DailyCheckInClaimQuery, predicate.DailyCheckInClaim, dailycheckinclaim.OrderOption]{typ: ent.TypeDailyCheckInClaim, tq: q}, nil
	...
	case *ent.UserAPIKeyRouteQuery:
		return &query[*ent.UserAPIKeyRouteQuery, predicate.UserAPIKeyRoute, userapikeyroute.OrderOption]{typ: ent.TypeUserAPIKeyRoute, tq: q}, nil
