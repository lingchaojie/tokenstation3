...
func init() {
	...
	usagelogDescImageInputTokens := usagelogFields[21].Descriptor()
	...
	usagelogDescImageInputCost := usagelogFields[26].Descriptor()
	...
	usagelogDescSessionID := usagelogFields[38].Descriptor()
