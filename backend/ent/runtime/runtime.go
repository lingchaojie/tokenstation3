...
func init() {
	...
	groupDescKiroCacheEmulationEnabled := groupFields[39].Descriptor()
	...
	groupDescKiroAutoStickyEnabled := groupFields[40].Descriptor()
	...
	groupDescKiroStickySessionTTLSeconds := groupFields[41].Descriptor()
	...
	groupDescKiroCacheEmulationRatio := groupFields[42].Descriptor()
	...
	groupDescKiroEndpointMode := groupFields[43].Descriptor()
	...
	subscriptionplanDescSeatLimit := subscriptionplanFields[12].Descriptor()
	...
	subscriptionplanDescVirtualSeatStart := subscriptionplanFields[13].Descriptor()
	...
	subscriptionplanDescVirtualSeatTotal := subscriptionplanFields[14].Descriptor()
