...
func init() {
	...
	// apikeyDescGroupBindingMode is the schema descriptor for group_binding_mode field.
	apikeyDescGroupBindingMode := apikeyFields[5].Descriptor()
	// apikey.DefaultGroupBindingMode holds the default value on creation for the group_binding_mode field.
	apikey.DefaultGroupBindingMode = apikeyDescGroupBindingMode.Default.(string)
	// apikey.GroupBindingModeValidator is a validator for the "group_binding_mode" field. It is called by the builders before save.
	apikey.GroupBindingModeValidator = apikeyDescGroupBindingMode.Validators[0].(func(string) error)
	...
	groupDescForceOpenaiFast := groupFields[44].Descriptor()
	...
	groupDescFreeOpenaiFast := groupFields[45].Descriptor()
	...
	groupDescCodexModelsManifestConfig := groupFields[51].Descriptor()
	...
	groupDescKiroCacheEmulationEnabled := groupFields[53].Descriptor()
	...
	groupDescKiroAutoStickyEnabled := groupFields[54].Descriptor()
	...
	groupDescKiroStickySessionTTLSeconds := groupFields[55].Descriptor()
	...
	groupDescKiroCacheEmulationRatio := groupFields[56].Descriptor()
	...
	groupDescKiroEndpointMode := groupFields[57].Descriptor()
	...
	// subscriptionplanDescSeatLimit is the schema descriptor for seat_limit field.
	subscriptionplanDescSeatLimit := subscriptionplanFields[13].Descriptor()
	// subscriptionplan.SeatLimitValidator is a validator for the "seat_limit" field. It is called by the builders before save.
	subscriptionplan.SeatLimitValidator = subscriptionplanDescSeatLimit.Validators[0].(func(int) error)
	// subscriptionplanDescVirtualSeatStart is the schema descriptor for virtual_seat_start field.
	subscriptionplanDescVirtualSeatStart := subscriptionplanFields[14].Descriptor()
	// subscriptionplan.VirtualSeatStartValidator is a validator for the "virtual_seat_start" field. It is called by the builders before save.
	subscriptionplan.VirtualSeatStartValidator = subscriptionplanDescVirtualSeatStart.Validators[0].(func(int) error)
	// subscriptionplanDescVirtualSeatTotal is the schema descriptor for virtual_seat_total field.
	subscriptionplanDescVirtualSeatTotal := subscriptionplanFields[15].Descriptor()
	// subscriptionplan.VirtualSeatTotalValidator is a validator for the "virtual_seat_total" field. It is called by the builders before save.
	subscriptionplan.VirtualSeatTotalValidator = subscriptionplanDescVirtualSeatTotal.Validators[0].(func(int) error)
	...
	usagelogDescRequestedReasoningEffort := usagelogFields[6].Descriptor()
	...
	usagelogDescImageInputCost := usagelogFields[27].Descriptor()
	...
	usagelogDescNativeCompactionV2 := usagelogFields[35].Descriptor()
	...
	usagelogDescSessionID := usagelogFields[40].Descriptor()
	...
	userDescSubscriptionBalanceFallbackEnabled := userFields[20].Descriptor()
	...
	// usersubscriptionDescScheduledPlanName is the schema descriptor for scheduled_plan_name field.
	usersubscriptionDescScheduledPlanName := usersubscriptionFields[6].Descriptor()
	// usersubscription.ScheduledPlanNameValidator is a validator for the "scheduled_plan_name" field. It is called by the builders before save.
	usersubscription.ScheduledPlanNameValidator = usersubscriptionDescScheduledPlanName.Validators[0].(func(string) error)
	// usersubscriptionDescStatus is the schema descriptor for status field.
	usersubscriptionDescStatus := usersubscriptionFields[13].Descriptor()
	...
	usersubscriptionDescDailyUsageUsd := usersubscriptionFields[17].Descriptor()
	...
	usersubscriptionDescWeeklyUsageUsd := usersubscriptionFields[18].Descriptor()
	...
	usersubscriptionDescMonthlyUsageUsd := usersubscriptionFields[19].Descriptor()
