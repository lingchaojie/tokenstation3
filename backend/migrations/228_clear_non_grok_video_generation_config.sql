...
COMMENT ON TABLE groups_video_price_backup_220 IS
    '迁移 228 清空非 Grok 分组视频价前的快照。确认无需回滚后可安全 DROP；回滚方式：UPDATE groups g SET video_price_480p = b.video_price_480p, ... FROM groups_video_price_backup_220 b WHERE g.id = b.group_id';
